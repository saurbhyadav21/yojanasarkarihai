...
================================ -->
    ...
    <section class="py-5">
        ...
        <div class="container">
            ...
            <div class="card border-0 shadow-lg rounded-5 p-5 text-center" style="background:#F8FAFC">
    ...
    <div class="modal fade" id="searchModal">
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content rounded-5 p-4">
                ...
                <input class="form-control form-control-lg mt-4" placeholder="PM Kisan, PM Awas...">
